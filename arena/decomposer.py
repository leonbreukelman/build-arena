...
SCHEMA_VERSION = "project-scanner/v0.1"
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        report = validate_project_model(scanner_model)
    ...
    if args.fail_on_gap and gap_count > 0:
        print(f"decomposition model has {gap_count} verification gap(s)", file=sys.stderr)
        return 3
    return 0
