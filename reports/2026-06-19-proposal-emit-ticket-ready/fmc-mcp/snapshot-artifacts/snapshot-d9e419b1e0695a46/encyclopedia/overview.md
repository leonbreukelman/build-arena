...
- `config` `.github/workflows/ci.yml` — [source://.github/workflows/ci.yml#L1] — Provenance `prov:a8e3d07508178794` via `filesystem` confidence `deterministic` hash `b700e09c3314`
...
## Features
```
- `file` `docs/index.md` — [source://docs/index.md#L1] — Provenance `prov:592d73a7b0037380` via `filesystem` confidence `deterministic` hash `1ce58e956015`
...
## Features
```
- `markdown_section` `Documentation Index` — symbol `docs/index.md#Documentation Index` — [source://docs/index.md#L1] — Provenance `prov:d324267b14cbb139` via `markdown_parser` confidence `deterministic` hash `1ce58e956015`
...
- `project` `build-arena-proposal-emit-fmc-mcp-origin` — [source://project] — Provenance `prov:project:94fdc1c0322e98ad` via `git` confidence `deterministic` hash `94fdc1c0322e`
...
- `python_import` `fmc_mcp.server.mcp` — symbol `fmc_mcp.server.mcp` — [source://src/fmc_mcp/__init__.py#L5] — Provenance `prov:1e2be92d09840adf` via `python_ast` confidence `deterministic` hash `e3b410a40e58`
...
- `python_import` `fmc_mcp.server.main` — symbol `fmc_mcp.server.main` — [source://src/fmc_mcp/__main__.py#L3] — Provenance `prov:e08d506150373eea` via `python_ast` confidence `deterministic` hash `d1518c9b8c7c`
...
class FMCSettings(BaseSettings):
    """FMC connection settings lo
```
- `python_import` `functools.lru_cache` — symbol `functools.lru_cache` — [source://src/fmc_mcp/config.py#L4] — Provenance `prov:b65ed2f73ad4b018` via `python_ast` confidence `deterministic` hash `f83817eb0668`
...
- `python_import` `contextlib.asynccontextmanager` — symbol `contextlib.asynccontextmanager` — [source://src/fmc_mcp/server.py#L7] — Provenance `prov:24bdbe0f3b14496c` via `python_ast` confidence `deterministic` hash `43a848b0fccc`
- `python_import` `fmc_mcp.config.get_settings` — symbol `fmc_mcp.config.get_settings` — [source://src/fmc_mcp/server.py#L13] — Provenance `prov:a490824f581f0eb5` via `python_ast` confidence `deterministic` hash `43a848b0fccc`
...
- `python_import` `fmc_mcp.resources.get_client` — symbol `fmc_mcp.resources.get_client` — [source://src/fmc_mcp/tools.py#L7] — Provenance `prov:3dfa2aaf889c6db2` via `python_ast` confidence `deterministic` hash `e9b53d858fde`
...
- `python_import` `fmc_mcp.resources` — symbol `fmc_mcp.resources` — [source://tests/test_resources.py#L8] — Provenance `prov:a57ff323145ecac8` via `python_ast` confidence `deterministic` hash `70e75562f3a1`
- `python_import` `fmc_mcp.tools` — symbol `fmc_mcp.tools` — [source://tests/test_resources.py#L8] — Provenance `prov:a57ff323145ecac8` via `python_ast` confidence `deterministic` hash `70e75562f3a1`
